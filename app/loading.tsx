  ...
  return (
    ...
    >
      ...
      <Image
        ...
        height={47.52}
        src="/images/Logo.svg"
        className="w-[182.88px] sm:w-[274.32px]  lg:w-[365.76px] h-auto sm:mb-5 lg:mb-5 z-30"
        alt="gates of olympus logo"
      />
      <div className="sm:h-10 w-5 h-5 sm:w-10 border-4 border-white border-t-transparent rounded-full animate-spin z-30"></div>
    </div>
  );
}
